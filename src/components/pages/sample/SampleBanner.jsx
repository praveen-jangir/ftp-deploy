...
import { servBanner, moviebanner } from './sampleData'
import { NavLink } from 'react-router-dom'

export default function SampleBanner(title) {
    return (
        <>
            <section className='ideal_banner sample_banner page-header2' style={{ backgroundImage: `url(${servBanner.backgroundImageUrl})` }}>
                <Container>
                                        ...
                                        <div className="carousel-item active">
                                            <div className="detail-box">
                                                <div className="top-left">
                                                    ...
                                                    <p dangerouslySetInnerHTML={{ __html: movie.text }}></p>
